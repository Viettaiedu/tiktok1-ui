const UploadIcon = ({ width = '2.4rem', height = '2.64rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const MailIcon = ({ width = '2.8rem', height = '2.64rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const SearchIcon = ({ width = '2.8rem', height = '2.64rem', className}) =>( 
...
export { UploadIcon, MailIcon , SearchIcon };
